...
const AddBanner = () => {
    ...
    return (
        <div className="rounded-lg w-11/12 md:w-11/12 lg:w-full mx-auto  p-6">
            ...
            <form onSubmit={handleAddBanner}>
                ...
                <button className="btn  btn-block btn-success text-white" type="submit">Add Banner</button>
